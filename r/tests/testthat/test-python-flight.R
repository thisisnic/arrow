...
if (process_is_running("demo_flight_server")) {
  ...
  test_that("flight_get", {
    expect_data_frame(flight_get(client, flight_obj), example_data)
  })
  ...
  test_that("flight_put with RecordBatch", {
    ...
    expect_data_frame(flight_get(client, flight_obj2), example_data)
  })
  ...
  test_that("flight_put with overwrite = FALSE", {
    ...
    expect_data_frame(flight_get(client, flight_obj), example_with_times)
  })
